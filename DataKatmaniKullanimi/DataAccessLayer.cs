...
namespace DataKatmani
{
    public class DataAccessLayer
    {
        ...
        {
            SqlConnection con = new SqlConnection(string.Format(@"server=WIN7-BILGISAYAR\SQLEXPRESS; database={0}; integrated security=true", dbName));
            con.Open();
            return con;
        }
        ///////////////////////////////////////////
        ...
        //isim,değer,tür SqlParameter kullanarak
